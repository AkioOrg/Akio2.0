...
class Moderation(commands.Cog):
    ...
    async def mute(
        ...
        *,
        ...
        if not get(ctx.guild.roles, name="Akio-Mute"):
            role = await ctx.guild.create_role(
<<<<<<< HEAD:cogs/moderation.py
                name="Akio-Mute", permissions=discord.Permissions(send_messages=False)
=======
                name="Kurisu-Mute",
                permissions=discord.Permissions(send_messages=False),
>>>>>>> 341df2d42fdaffaf8e877355789432b4bdd741be:kurisu/cogs/moderation.py
            )
        ...
        elif get(ctx.guild.roles, name="Akio-Mute"):
            await member.add_roles(get(ctx.guild.roles, name="Akio-Mute"))
            await ctx.send(
                embed=discord.Embed(
                    description=f":shushing_face: Successfully muted `{member}` for `{reason}`",
                    color=self.bot.ok_color,
    ...
    async def unmute(self, ctx: KurisuContext, member: discord.Member):
        """Unmute a member"""
        if not get(ctx.guild.roles, name="Akio-Mute") in member.roles:
            await ctx.send(
                embed=discord.Embed(
        ...
        elif get(ctx.guild.roles, name="Akio-Mute") in member.roles:
            await member.remove_roles(get(ctx.guild.roles, name="Akio-Mute"))
            await ctx.send(
                embed=discord.Embed(
